...
export class DealsDeliveryChallanComponent implements OnInit {
  ...
  maxQuantity(productId) {
    // console.log(productId + " :: " + this.reminingDealProducts.find(rp => rp.productId == productId).quantity);
    return this.reminingDealProducts.find(rp => rp.productId == productId).quantity;
  }

...
import { MatFormFieldModule, MatInputModule, MatProgressBarModule, MatSelectModule, MatDialogModule, MatButtonModule, MatCheckboxModule, MatRadioModule, MatSlideToggleModule, MatIconModule } from '@angular/material';
...
@NgModule({
  declarations: [LeadMailTemplatesComponent, LeadMailSettingsComponent, LeadMailTemplateCreateComponent,
    LeadMailSentStatusComponent],
  imports: [
    CommonModule,
